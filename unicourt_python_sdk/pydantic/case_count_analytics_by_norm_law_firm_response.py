...
from unicourt_python_sdk.pydantic.case_count_analytics_by_norm_law_firm import CaseCountAnalyticsByNormLawFirm
...
class CaseCountAnalyticsByNormLawFirmResponse(BaseModel):
    ...
    results: typing.List[CaseCountAnalyticsByNormLawFirm] = Field(alias='results')
    ...
    total_norm_law_firm_count: int = Field(alias='totalNormLawFirmCount')
