...
from unicourt_python_sdk.pydantic.norm_law_firm_search_result import NormLawFirmSearchResult
...
class NormLawFirmSearchResponse(BaseModel):
    ...
    norm_law_firm_search_id: str = Field(alias='normLawFirmSearchId')

    norm_law_firm_search_result_array: typing.List[NormLawFirmSearchResult] = Field(alias='normLawFirmSearchResultArray')
