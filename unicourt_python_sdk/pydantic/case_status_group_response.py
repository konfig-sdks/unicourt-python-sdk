...
from unicourt_python_sdk.pydantic.case_status_group import CaseStatusGroup

class CaseStatusGroupResponse(BaseModel):
    case_status_group_array: typing.List[CaseStatusGroup] = Field(alias='caseStatusGroupArray')
