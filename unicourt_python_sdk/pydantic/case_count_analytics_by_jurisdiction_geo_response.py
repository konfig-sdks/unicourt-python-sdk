...
from unicourt_python_sdk.pydantic.case_count_analytics_by_jurisdiction_geo import CaseCountAnalyticsByJurisdictionGeo
...
class CaseCountAnalyticsByJurisdictionGeoResponse(BaseModel):
    ...
    results: typing.List[CaseCountAnalyticsByJurisdictionGeo] = Field(alias='results')
    ...
    total_jurisdiction_geo_count: int = Field(alias='totalJurisdictionGeoCount')
