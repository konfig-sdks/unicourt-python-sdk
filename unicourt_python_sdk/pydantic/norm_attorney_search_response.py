...
from unicourt_python_sdk.pydantic.norm_attorney_search_result import NormAttorneySearchResult
...
class NormAttorneySearchResponse(BaseModel):
    ...
    norm_attorney_search_id: str = Field(alias='normAttorneySearchId')

    norm_attorney_search_result_array: typing.List[NormAttorneySearchResult] = Field(alias='normAttorneySearchResultArray')
