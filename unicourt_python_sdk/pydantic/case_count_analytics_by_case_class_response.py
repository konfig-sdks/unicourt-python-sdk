...
from unicourt_python_sdk.pydantic.case_count_analytics_by_case_class import CaseCountAnalyticsByCaseClass
...
class CaseCountAnalyticsByCaseClassResponse(BaseModel):
    ...
    results: typing.List[CaseCountAnalyticsByCaseClass] = Field(alias='results')

    # Total no. of Case Class for this criteria.
    total_case_class_count: int = Field(alias='totalCaseClassCount')
