...
from unicourt_python_sdk.pydantic.case_document_order_callback import CaseDocumentOrderCallback

class CaseDocumentOrderCallbackListResponse(BaseModel):
    # Array of case document order callback objects.
    callback_array: typing.List[CaseDocumentOrderCallback] = Field(alias='callbackArray')
