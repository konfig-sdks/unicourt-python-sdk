...
from unicourt_python_sdk.pydantic.case_export_callback import CaseExportCallback

class CaseExportCallbackListResponse(BaseModel):
    # Array of case export callback objects.
    callback_array: typing.List[CaseExportCallback] = Field(alias='callbackArray')
