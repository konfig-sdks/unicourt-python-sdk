...
from unicourt_python_sdk.pydantic.associated_norm_party import AssociatedNormParty

class AssociatedNormPartyResponse(BaseModel):
    associated_norm_party_array: typing.List[AssociatedNormParty] = Field(alias='associatedNormPartyArray')
