...
from unicourt_python_sdk.pydantic.associated_norm_judge import AssociatedNormJudge

class AssociatedNormJudgeResponse(BaseModel):
    associated_norm_judge_array: typing.List[AssociatedNormJudge] = Field(alias='associatedNormJudgeArray')
