...
from unicourt_python_sdk.pydantic.cause_of_action_group import CauseOfActionGroup

class CauseOfActionGroupResponse(BaseModel):
    cause_of_action_group_array: typing.List[CauseOfActionGroup] = Field(alias='causeOfActionGroupArray')
