...
from unicourt_python_sdk.pydantic.case_count_analytics_by_court_system import CaseCountAnalyticsByCourtSystem
...
class CaseCountAnalyticsByCourtSystemResponse(BaseModel):
    ...
    results: typing.List[CaseCountAnalyticsByCourtSystem] = Field(alias='results')
    ...
    total_court_system_count: int = Field(alias='totalCourtSystemCount')
