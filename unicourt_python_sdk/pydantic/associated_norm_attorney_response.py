...
from unicourt_python_sdk.pydantic.associated_norm_attorney import AssociatedNormAttorney

class AssociatedNormAttorneyResponse(BaseModel):
    associated_norm_attorney_array: typing.List[AssociatedNormAttorney] = Field(alias='associatedNormAttorneyArray')
