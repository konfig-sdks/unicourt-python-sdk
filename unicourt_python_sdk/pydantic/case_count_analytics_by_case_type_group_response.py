...
from unicourt_python_sdk.pydantic.case_count_analytics_by_case_type_group import CaseCountAnalyticsByCaseTypeGroup
...
class CaseCountAnalyticsByCaseTypeGroupResponse(BaseModel):
    ...
    results: typing.List[CaseCountAnalyticsByCaseTypeGroup] = Field(alias='results')
    ...
    total_case_type_group_count: int = Field(alias='totalCaseTypeGroupCount')
