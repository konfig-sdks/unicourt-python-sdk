...
from unicourt_python_sdk.pydantic.court_service_status import CourtServiceStatus

class CourtServiceStatusResponse(BaseModel):
    court_service_status_array: typing.List[CourtServiceStatus] = Field(alias='courtServiceStatusArray')
