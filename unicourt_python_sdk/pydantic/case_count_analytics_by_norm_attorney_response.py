...
from unicourt_python_sdk.pydantic.case_count_analytics_by_norm_attorney import CaseCountAnalyticsByNormAttorney
...
class CaseCountAnalyticsByNormAttorneyResponse(BaseModel):
    ...
    results: typing.List[CaseCountAnalyticsByNormAttorney] = Field(alias='results')
    ...
    total_norm_attorney_count: int = Field(alias='totalNormAttorneyCount')
