...
from unicourt_python_sdk.pydantic.case_count_analytics_by_case_type import CaseCountAnalyticsByCaseType
...
class CaseCountAnalyticsByCaseTypeResponse(BaseModel):
    ...
    results: typing.List[CaseCountAnalyticsByCaseType] = Field(alias='results')

    # Total no. of Cases for this criteria.
    total_case_count: int = Field(alias='totalCaseCount')

    # Total no. of CaseType for this criteria.
    total_case_type_count: int = Field(alias='totalCaseTypeCount')
