...
from unicourt_python_sdk.pydantic.case_count_analytics_by_party_role import CaseCountAnalyticsByPartyRole
...
class CaseCountAnalyticsByPartyRoleResponse(BaseModel):
    ...
    results: typing.List[CaseCountAnalyticsByPartyRole] = Field(alias='results')
    ...
    total_party_role_count: int = Field(alias='totalPartyRoleCount')
    class Config:
