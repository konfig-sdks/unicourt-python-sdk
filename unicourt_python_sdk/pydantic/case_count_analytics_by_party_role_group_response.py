...
from unicourt_python_sdk.pydantic.case_count_analytics_by_party_role_group import CaseCountAnalyticsByPartyRoleGroup
...
class CaseCountAnalyticsByPartyRoleGroupResponse(BaseModel):
    ...
    results: typing.List[CaseCountAnalyticsByPartyRoleGroup] = Field(alias='results')
    ...
    total_party_role_group_count: int = Field(alias='totalPartyRoleGroupCount')
    class Config:
