...
from unicourt_python_sdk.pydantic.case_update_pacer_options_additional_page_array import CaseUpdatePacerOptionsAdditionalPageArray
...
class CaseUpdatePacerOptions(BaseModel):
    ...
    additional_page_array: typing.Optional[CaseUpdatePacerOptionsAdditionalPageArray] = Field(None, alias='additionalPageArray')
    ...
    fetch_participants_if_older_than_days: typing.Optional[int] = Field(None, alias='fetchParticipantsIfOlderThanDays')
    ...
    refresh_type: typing.Optional[Literal["fetchNewDocketEntries", "fetchAllDocketEntries"]] = Field(None, alias='refreshType')
    class Config:
