...
from unicourt_python_sdk.pydantic.case_count_analytics_by_norm_judge import CaseCountAnalyticsByNormJudge
...
class CaseCountAnalyticsByNormJudgeResponse(BaseModel):
    ...
    results: typing.List[CaseCountAnalyticsByNormJudge] = Field(alias='results')
    ...
    total_norm_judge_count: int = Field(alias='totalNormJudgeCount')
