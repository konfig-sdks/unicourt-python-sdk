...
from unicourt_python_sdk.pydantic.case_count_analytics_by_area_of_law import CaseCountAnalyticsByAreaOfLaw
...
class CaseCountAnalyticsByAreaOfLawResponse(BaseModel):
    ...
    results: typing.List[CaseCountAnalyticsByAreaOfLaw] = Field(alias='results')

    # Total no. of Area Of Law for this criteria.
    total_area_of_law_count: int = Field(alias='totalAreaOfLawCount')
