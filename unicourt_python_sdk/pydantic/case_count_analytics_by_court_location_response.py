...
from unicourt_python_sdk.pydantic.case_count_analytics_by_court_location import CaseCountAnalyticsByCourtLocation
...
class CaseCountAnalyticsByCourtLocationResponse(BaseModel):
    ...
    results: typing.List[CaseCountAnalyticsByCourtLocation] = Field(alias='results')
    ...
    total_court_location_count: int = Field(alias='totalCourtLocationCount')
