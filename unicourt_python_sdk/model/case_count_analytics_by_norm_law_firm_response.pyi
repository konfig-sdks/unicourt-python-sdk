...
class CaseCountAnalyticsByNormLawFirmResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CaseCountAnalyticsByNormLawFirm']:
                        return CaseCountAnalyticsByNormLawFirm
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CaseCountAnalyticsByNormLawFirm'], typing.List['CaseCountAnalyticsByNormLawFirm']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'CaseCountAnalyticsByNormLawFirm':
                    return super().__getitem__(i)
            totalCaseCount = schemas.IntSchema
            totalNormLawFirmCount = schemas.IntSchema
            ...
            __annotations__ = {
                ...
                "totalNormLawFirmCount": totalNormLawFirmCount,
                "totalPages": totalPages,
            }
    
    nextPageAPI: MetaOapg.properties.nextPageAPI
    previousPageAPI: MetaOapg.properties.previousPageAPI
    totalNormLawFirmCount: MetaOapg.properties.totalNormLawFirmCount
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["totalNormLawFirmCount"]) -> MetaOapg.properties.totalNormLawFirmCount: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalCaseCount", "totalNormLawFirmCount", "totalPages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["totalNormLawFirmCount"]) -> MetaOapg.properties.totalNormLawFirmCount: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalCaseCount", "totalNormLawFirmCount", "totalPages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        totalNormLawFirmCount: typing.Union[MetaOapg.properties.totalNormLawFirmCount, decimal.Decimal, int, ],
