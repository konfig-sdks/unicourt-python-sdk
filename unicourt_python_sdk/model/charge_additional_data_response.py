...
class ChargeAdditionalDataResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["chargeAdditionalDataArray", "nextPageAPI", "object", "pageNumber", "previousPageAPI", "totalCount", "totalPages", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["chargeAdditionalDataArray", "nextPageAPI", "object", "pageNumber", "previousPageAPI", "totalCount", "totalPages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        chargeAdditionalDataArray: typing.Union[MetaOapg.properties.chargeAdditionalDataArray, list, tuple, ],
