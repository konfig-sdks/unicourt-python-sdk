...
class Judges(
        ...
        class properties:
            ...
            class judgeArray(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Judge']:
                        return Judge
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Judge'], typing.List['Judge']],
                ...
                def __getitem__(self, i: int) -> 'Judge':
    ...
    judgeArray: MetaOapg.properties.judgeArray
    totalCount: MetaOapg.properties.totalCount
    object: MetaOapg.properties.object
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["judgeArray"]) -> MetaOapg.properties.judgeArray: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["judgeArray", "nextPageAPI", "object", "pageNumber", "totalCount", "totalPages", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["judgeArray"]) -> MetaOapg.properties.judgeArray: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["judgeArray", "nextPageAPI", "object", "pageNumber", "totalCount", "totalPages", ], str]):
