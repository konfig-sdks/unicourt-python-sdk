...
class CaseRelationshipTypeResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class caseRelationshipTypeArray(
                schemas.ListSchema
            ):
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CaseRelationshipType']:
                        return CaseRelationshipType
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CaseRelationshipType'], typing.List['CaseRelationshipType']],
                ...
                def __getitem__(self, i: int) -> 'CaseRelationshipType':
            ...
            class totalPages(
                ...
                class MetaOapg:
            __annotations__ = {
                "caseRelationshipTypeArray": caseRelationshipTypeArray,
    ...
    caseRelationshipTypeArray: MetaOapg.properties.caseRelationshipTypeArray
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["caseRelationshipTypeArray"]) -> MetaOapg.properties.caseRelationshipTypeArray: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["caseRelationshipTypeArray", "nextPageAPI", "object", "pageNumber", "previousPageAPI", "totalCount", "totalPages", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["caseRelationshipTypeArray"]) -> MetaOapg.properties.caseRelationshipTypeArray: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["caseRelationshipTypeArray", "nextPageAPI", "object", "pageNumber", "previousPageAPI", "totalCount", "totalPages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        caseRelationshipTypeArray: typing.Union[MetaOapg.properties.caseRelationshipTypeArray, list, tuple, ],
