...
class CaseTrackPreview(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["caseAPI", "caseId", "lastFetchDate", "lastFetchDateWithUpdates", "lastTrackedDetails", "object", "pacerOptions", "schedule", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["caseAPI", "caseId", "lastFetchDate", "lastFetchDateWithUpdates", "lastTrackedDetails", "object", "pacerOptions", "schedule", ], str]):
