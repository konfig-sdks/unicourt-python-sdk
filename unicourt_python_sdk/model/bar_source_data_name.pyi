...
class BarSourceDataName(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["firstName", "lastName", "middleName", "name", "prefix", "suffix", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["firstName", "lastName", "middleName", "name", "prefix", "suffix", ], str]):
