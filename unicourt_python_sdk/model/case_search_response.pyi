...
class CaseSearchResponse(
        ...
        class properties:
            ...
            class caseSearchResultArray(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CaseSearchResult']:
                        return CaseSearchResult
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CaseSearchResult'], typing.List['CaseSearchResult']],
                ...
                def __getitem__(self, i: int) -> 'CaseSearchResult':
            ...
            class totalPages(
                ...
                pass
            __annotations__ = {
                "caseSearchId": caseSearchId,
                "caseSearchResultArray": caseSearchResultArray,
    ...
    caseSearchId: MetaOapg.properties.caseSearchId
    caseSearchResultArray: MetaOapg.properties.caseSearchResultArray
    totalCount: MetaOapg.properties.totalCount
    object: MetaOapg.properties.object
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["caseSearchId"]) -> MetaOapg.properties.caseSearchId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["caseSearchResultArray"]) -> MetaOapg.properties.caseSearchResultArray: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["caseSearchId", "caseSearchResultArray", "nextPageAPI", "object", "pageNumber", "previousPageAPI", "q", "totalCount", "totalPages", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["caseSearchId"]) -> MetaOapg.properties.caseSearchId: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["caseSearchResultArray"]) -> MetaOapg.properties.caseSearchResultArray: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["caseSearchId", "caseSearchResultArray", "nextPageAPI", "object", "pageNumber", "previousPageAPI", "q", "totalCount", "totalPages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        caseSearchId: typing.Union[MetaOapg.properties.caseSearchId, str, ],
        caseSearchResultArray: typing.Union[MetaOapg.properties.caseSearchResultArray, list, tuple, ],
