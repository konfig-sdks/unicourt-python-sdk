...
class NormPartySearchResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class normPartySearchId(
                schemas.StrSchema
            ):
                pass
            
            
            class normPartySearchResultArray(
                schemas.ListSchema
            ):
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['NormPartySearchResult']:
                        return NormPartySearchResult
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['NormPartySearchResult'], typing.List['NormPartySearchResult']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'normPartySearchResultArray':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'NormPartySearchResult':
            ...
            __annotations__ = {
                ...
                "normPartySearchId": normPartySearchId,
                "normPartySearchResultArray": normPartySearchResultArray,
                "object": object,
    ...
    normPartySearchResultArray: MetaOapg.properties.normPartySearchResultArray
    pageNumber: MetaOapg.properties.pageNumber
    nextPageAPI: MetaOapg.properties.nextPageAPI
    normPartySearchId: MetaOapg.properties.normPartySearchId
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["normPartySearchId"]) -> MetaOapg.properties.normPartySearchId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["normPartySearchResultArray"]) -> MetaOapg.properties.normPartySearchResultArray: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "normPartySearchId", "normPartySearchResultArray", "object", "pageNumber", "previousPageAPI", "q", "totalCount", "totalPages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["normPartySearchId"]) -> MetaOapg.properties.normPartySearchId: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["normPartySearchResultArray"]) -> MetaOapg.properties.normPartySearchResultArray: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "normPartySearchId", "normPartySearchResultArray", "object", "pageNumber", "previousPageAPI", "q", "totalCount", "totalPages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        normPartySearchResultArray: typing.Union[MetaOapg.properties.normPartySearchResultArray, list, tuple, ],
        ...
        normPartySearchId: typing.Union[MetaOapg.properties.normPartySearchId, str, ],
