...
class Attorneys(
        ...
        class properties:
            ...
            class attorneyArray(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Attorney']:
                        return Attorney
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Attorney'], typing.List['Attorney']],
                ...
                def __getitem__(self, i: int) -> 'Attorney':
    ...
    attorneyArray: MetaOapg.properties.attorneyArray
    totalCount: MetaOapg.properties.totalCount
    object: MetaOapg.properties.object
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["attorneyArray"]) -> MetaOapg.properties.attorneyArray: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["attorneyArray", "nextPageAPI", "object", "pageNumber", "totalCount", "totalPages", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["attorneyArray"]) -> MetaOapg.properties.attorneyArray: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["attorneyArray", "nextPageAPI", "object", "pageNumber", "totalCount", "totalPages", ], str]):
