...
class CaseCountAnalyticsByCourtLocationResponse(
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CaseCountAnalyticsByCourtLocation']:
                        return CaseCountAnalyticsByCourtLocation
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CaseCountAnalyticsByCourtLocation'], typing.List['CaseCountAnalyticsByCourtLocation']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'CaseCountAnalyticsByCourtLocation':
                    return super().__getitem__(i)
            totalCaseCount = schemas.IntSchema
            totalCourtLocationCount = schemas.IntSchema
            ...
            __annotations__ = {
                ...
                "totalCourtLocationCount": totalCourtLocationCount,
    ...
    totalCourtLocationCount: MetaOapg.properties.totalCourtLocationCount
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["totalCourtLocationCount"]) -> MetaOapg.properties.totalCourtLocationCount: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalCaseCount", "totalCourtLocationCount", "totalPages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["totalCourtLocationCount"]) -> MetaOapg.properties.totalCourtLocationCount: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalCaseCount", "totalCourtLocationCount", "totalPages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        totalCourtLocationCount: typing.Union[MetaOapg.properties.totalCourtLocationCount, decimal.Decimal, int, ],
