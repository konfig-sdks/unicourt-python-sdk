...
class CaseCountAnalyticsByCourtTypeResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CaseCountAnalyticsByCourtType']:
                        return CaseCountAnalyticsByCourtType
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CaseCountAnalyticsByCourtType'], typing.List['CaseCountAnalyticsByCourtType']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'CaseCountAnalyticsByCourtType':
                    return super().__getitem__(i)
            totalCaseCount = schemas.IntSchema
            totalCourtTypeCount = schemas.IntSchema
            ...
            __annotations__ = {
                ...
                "totalCourtTypeCount": totalCourtTypeCount,
                "totalPages": totalPages,
            }
    
    nextPageAPI: MetaOapg.properties.nextPageAPI
    totalCourtTypeCount: MetaOapg.properties.totalCourtTypeCount
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["totalCourtTypeCount"]) -> MetaOapg.properties.totalCourtTypeCount: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalCaseCount", "totalCourtTypeCount", "totalPages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["totalCourtTypeCount"]) -> MetaOapg.properties.totalCourtTypeCount: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalCaseCount", "totalCourtTypeCount", "totalPages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        totalCourtTypeCount: typing.Union[MetaOapg.properties.totalCourtTypeCount, decimal.Decimal, int, ],
