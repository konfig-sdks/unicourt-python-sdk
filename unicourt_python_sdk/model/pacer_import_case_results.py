...
class PACERImportCaseResults(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["hasOnlyMetaInfo", "object", "uniCourtContent", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["hasOnlyMetaInfo", "object", "uniCourtContent", ], str]):
