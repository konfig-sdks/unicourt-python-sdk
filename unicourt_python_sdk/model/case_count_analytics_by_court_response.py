...
class CaseCountAnalyticsByCourtResponse(
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CaseCountAnalyticsByCourt']:
                        return CaseCountAnalyticsByCourt
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CaseCountAnalyticsByCourt'], typing.List['CaseCountAnalyticsByCourt']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'CaseCountAnalyticsByCourt':
                    return super().__getitem__(i)
            totalCaseCount = schemas.IntSchema
            totalCourtCount = schemas.IntSchema
    ...
    totalCourtCount: MetaOapg.properties.totalCourtCount
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["totalCourtCount"]) -> MetaOapg.properties.totalCourtCount: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalCaseCount", "totalCourtCount", "totalPages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["totalCourtCount"]) -> MetaOapg.properties.totalCourtCount: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalCaseCount", "totalCourtCount", "totalPages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        totalCourtCount: typing.Union[MetaOapg.properties.totalCourtCount, decimal.Decimal, int, ],
