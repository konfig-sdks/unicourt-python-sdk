...
class CaseCountAnalyticsByCourtSystemResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CaseCountAnalyticsByCourtSystem']:
                        return CaseCountAnalyticsByCourtSystem
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CaseCountAnalyticsByCourtSystem'], typing.List['CaseCountAnalyticsByCourtSystem']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'CaseCountAnalyticsByCourtSystem':
                    return super().__getitem__(i)
            totalCaseCount = schemas.IntSchema
            totalCourtSystemCount = schemas.IntSchema
            ...
            __annotations__ = {
                ...
                "totalCourtSystemCount": totalCourtSystemCount,
                "totalPages": totalPages,
            }
    
    nextPageAPI: MetaOapg.properties.nextPageAPI
    previousPageAPI: MetaOapg.properties.previousPageAPI
    totalCourtSystemCount: MetaOapg.properties.totalCourtSystemCount
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["totalCourtSystemCount"]) -> MetaOapg.properties.totalCourtSystemCount: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalCaseCount", "totalCourtSystemCount", "totalPages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["totalCourtSystemCount"]) -> MetaOapg.properties.totalCourtSystemCount: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalCaseCount", "totalCourtSystemCount", "totalPages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        totalCourtSystemCount: typing.Union[MetaOapg.properties.totalCourtSystemCount, decimal.Decimal, int, ],
