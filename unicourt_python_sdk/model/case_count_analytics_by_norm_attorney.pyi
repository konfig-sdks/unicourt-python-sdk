...
class CaseCountAnalyticsByNormAttorney(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["caseCount", "caseSearchAPI", "normAttorneyId", "normAttorneyName", "object", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["caseCount", "caseSearchAPI", "normAttorneyId", "normAttorneyName", "object", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        normAttorneyName: typing.Union[MetaOapg.properties.normAttorneyName, str, ],
