...
class BarSourceDataReasonForInactivation(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["caseNumber", "link", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["caseNumber", "link", ], str]):
