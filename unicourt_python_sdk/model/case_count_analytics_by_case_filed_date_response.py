...
class CaseCountAnalyticsByCaseFiledDateResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CaseCountAnalyticsByCaseFiledDate']:
                        return CaseCountAnalyticsByCaseFiledDate
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CaseCountAnalyticsByCaseFiledDate'], typing.List['CaseCountAnalyticsByCaseFiledDate']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'CaseCountAnalyticsByCaseFiledDate':
                    return super().__getitem__(i)
            totalCaseCount = schemas.IntSchema
            totalCaseFiledDateCount = schemas.IntSchema
            ...
            __annotations__ = {
                ...
                "totalCaseFiledDateCount": totalCaseFiledDateCount,
                "totalPages": totalPages,
            }
    
    nextPageAPI: MetaOapg.properties.nextPageAPI
    totalCaseFiledDateCount: MetaOapg.properties.totalCaseFiledDateCount
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["totalCaseFiledDateCount"]) -> MetaOapg.properties.totalCaseFiledDateCount: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalCaseCount", "totalCaseFiledDateCount", "totalPages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["totalCaseFiledDateCount"]) -> MetaOapg.properties.totalCaseFiledDateCount: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalCaseCount", "totalCaseFiledDateCount", "totalPages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        totalCaseFiledDateCount: typing.Union[MetaOapg.properties.totalCaseFiledDateCount, decimal.Decimal, int, ],
