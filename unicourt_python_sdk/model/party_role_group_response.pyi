...
class PartyRoleGroupResponse(
        ...
        class properties:
            ...
            class partyRoleGroupArray(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PartyRoleGroup']:
                        return PartyRoleGroup
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['PartyRoleGroup'], typing.List['PartyRoleGroup']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'partyRoleGroupArray':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'PartyRoleGroup':
            ...
            __annotations__ = {
                ...
                "partyRoleGroupArray": partyRoleGroupArray,
                "previousPageAPI": previousPageAPI,
                "totalCount": totalCount,
                "totalPages": totalPages,
            }
    
    partyRoleGroupArray: MetaOapg.properties.partyRoleGroupArray
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["partyRoleGroupArray"]) -> MetaOapg.properties.partyRoleGroupArray: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "pageNumber", "partyRoleGroupArray", "previousPageAPI", "totalCount", "totalPages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["partyRoleGroupArray"]) -> MetaOapg.properties.partyRoleGroupArray: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "pageNumber", "partyRoleGroupArray", "previousPageAPI", "totalCount", "totalPages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        partyRoleGroupArray: typing.Union[MetaOapg.properties.partyRoleGroupArray, list, tuple, ],
