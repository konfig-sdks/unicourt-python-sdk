...
class ChargeResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["chargeArray", "nextPageAPI", "object", "pageNumber", "previousPageAPI", "totalCount", "totalPages", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["chargeArray", "nextPageAPI", "object", "pageNumber", "previousPageAPI", "totalCount", "totalPages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        chargeArray: typing.Union[MetaOapg.properties.chargeArray, list, tuple, ],
