...
class CaseCountAnalyticsByJurisdictionGeoResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CaseCountAnalyticsByJurisdictionGeo']:
                        return CaseCountAnalyticsByJurisdictionGeo
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CaseCountAnalyticsByJurisdictionGeo'], typing.List['CaseCountAnalyticsByJurisdictionGeo']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'CaseCountAnalyticsByJurisdictionGeo':
                    return super().__getitem__(i)
            totalCaseCount = schemas.IntSchema
            totalJurisdictionGeoCount = schemas.IntSchema
            ...
            __annotations__ = {
                ...
                "totalJurisdictionGeoCount": totalJurisdictionGeoCount,
    ...
    totalJurisdictionGeoCount: MetaOapg.properties.totalJurisdictionGeoCount
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["totalJurisdictionGeoCount"]) -> MetaOapg.properties.totalJurisdictionGeoCount: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalCaseCount", "totalJurisdictionGeoCount", "totalPages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["totalJurisdictionGeoCount"]) -> MetaOapg.properties.totalJurisdictionGeoCount: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalCaseCount", "totalJurisdictionGeoCount", "totalPages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        totalJurisdictionGeoCount: typing.Union[MetaOapg.properties.totalJurisdictionGeoCount, decimal.Decimal, int, ],
