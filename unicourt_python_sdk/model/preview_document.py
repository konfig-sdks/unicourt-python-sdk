...
class PreviewDocument(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["addedToLibraryDate", "downloadAPI", "inLibrary", "object", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["addedToLibraryDate", "downloadAPI", "inLibrary", "object", ], str]):
