...
class CaseCountAnalyticsByAreaOfLawResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CaseCountAnalyticsByAreaOfLaw']:
                        return CaseCountAnalyticsByAreaOfLaw
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CaseCountAnalyticsByAreaOfLaw'], typing.List['CaseCountAnalyticsByAreaOfLaw']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'CaseCountAnalyticsByAreaOfLaw':
                    return super().__getitem__(i)
            totalAreaOfLawCount = schemas.IntSchema
            ...
            __annotations__ = {
                ...
                "results": results,
                "totalAreaOfLawCount": totalAreaOfLawCount,
                "totalCaseCount": totalCaseCount,
                "totalPages": totalPages,
            }
    
    nextPageAPI: MetaOapg.properties.nextPageAPI
    totalAreaOfLawCount: MetaOapg.properties.totalAreaOfLawCount
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["totalAreaOfLawCount"]) -> MetaOapg.properties.totalAreaOfLawCount: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalAreaOfLawCount", "totalCaseCount", "totalPages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["totalAreaOfLawCount"]) -> MetaOapg.properties.totalAreaOfLawCount: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalAreaOfLawCount", "totalCaseCount", "totalPages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        totalAreaOfLawCount: typing.Union[MetaOapg.properties.totalAreaOfLawCount, decimal.Decimal, int, ],
