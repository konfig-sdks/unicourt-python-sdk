...
class PacerCredentialListResponse(
        ...
        class properties:
            ...
            class pacerCredentialArray(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PacerCredential']:
                        return PacerCredential
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['PacerCredential'], typing.List['PacerCredential']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'pacerCredentialArray':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'PacerCredential':
            ...
            __annotations__ = {
                ...
                "object": object,
                "pacerCredentialArray": pacerCredentialArray,
    ...
    pacerCredentialArray: MetaOapg.properties.pacerCredentialArray
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["pacerCredentialArray"]) -> MetaOapg.properties.pacerCredentialArray: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "pacerCredentialArray", "pageNumber", "previousPageAPI", "totalCount", "totalPages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["pacerCredentialArray"]) -> MetaOapg.properties.pacerCredentialArray: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "pacerCredentialArray", "pageNumber", "previousPageAPI", "totalCount", "totalPages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        pacerCredentialArray: typing.Union[MetaOapg.properties.pacerCredentialArray, list, tuple, ],
