...
class CaseCountAnalyticsByNormJudgeResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class results(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CaseCountAnalyticsByNormJudge']:
                        return CaseCountAnalyticsByNormJudge
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['CaseCountAnalyticsByNormJudge'], typing.List['CaseCountAnalyticsByNormJudge']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'results':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'CaseCountAnalyticsByNormJudge':
                    return super().__getitem__(i)
            totalCaseCount = schemas.IntSchema
            totalNormJudgeCount = schemas.IntSchema
            ...
            __annotations__ = {
                ...
                "totalNormJudgeCount": totalNormJudgeCount,
                "totalPages": totalPages,
            }
    
    totalNormJudgeCount: MetaOapg.properties.totalNormJudgeCount
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["totalNormJudgeCount"]) -> MetaOapg.properties.totalNormJudgeCount: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalCaseCount", "totalNormJudgeCount", "totalPages", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["totalNormJudgeCount"]) -> MetaOapg.properties.totalNormJudgeCount: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nextPageAPI", "object", "previousPageAPI", "results", "totalCaseCount", "totalNormJudgeCount", "totalPages", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        totalNormJudgeCount: typing.Union[MetaOapg.properties.totalNormJudgeCount, decimal.Decimal, int, ],
