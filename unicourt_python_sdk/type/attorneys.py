...
class RequiredAttorneys(TypedDict):
    attorneyArray: typing.List[Attorney]
...
class OptionalAttorneys(TypedDict, total=False):
    pass

class Attorneys(RequiredAttorneys, OptionalAttorneys):
    pass
