...
class RequiredCaseTypeResponse(TypedDict):
    caseTypeArray: typing.List[CaseType]
...
class OptionalCaseTypeResponse(TypedDict, total=False):
    pass

class CaseTypeResponse(RequiredCaseTypeResponse, OptionalCaseTypeResponse):
    pass
