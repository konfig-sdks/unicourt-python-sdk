...
class OptionalCaseExportCallback(TypedDict, total=False):
    pass

class CaseExportCallback(RequiredCaseExportCallback, OptionalCaseExportCallback):
    pass
