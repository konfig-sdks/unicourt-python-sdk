...
class RequiredCaseTrackPreview(TypedDict):
    caseAPI: str
...
class OptionalCaseTrackPreview(TypedDict, total=False):
    pass

class CaseTrackPreview(RequiredCaseTrackPreview, OptionalCaseTrackPreview):
    pass
