...
class RequiredCaseUpdatePacerOptionsAdditionalPageArrayItem(TypedDict):
    pass

class OptionalCaseUpdatePacerOptionsAdditionalPageArrayItem(TypedDict, total=False):
...
class CaseUpdatePacerOptionsAdditionalPageArrayItem(RequiredCaseUpdatePacerOptionsAdditionalPageArrayItem, OptionalCaseUpdatePacerOptionsAdditionalPageArrayItem):
    pass
