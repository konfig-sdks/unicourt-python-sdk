...
class RequiredDocketEntryPrimaryDocuments(TypedDict):
...
class OptionalDocketEntryPrimaryDocuments(TypedDict, total=False):
    pass

class DocketEntryPrimaryDocuments(RequiredDocketEntryPrimaryDocuments, OptionalDocketEntryPrimaryDocuments):
    pass
