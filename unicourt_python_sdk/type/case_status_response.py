...
class RequiredCaseStatusResponse(TypedDict):
    caseStatusArray: typing.List[CaseStatus]
...
class OptionalCaseStatusResponse(TypedDict, total=False):
    pass

class CaseStatusResponse(RequiredCaseStatusResponse, OptionalCaseStatusResponse):
    pass
