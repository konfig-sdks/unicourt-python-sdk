...
from unicourt_python_sdk.type.related_case import RelatedCase

class RequiredRelatedCases(TypedDict):
    ...
    relatedCaseArray: typing.List[RelatedCase]
...
class OptionalRelatedCases(TypedDict, total=False):
    pass

class RelatedCases(RequiredRelatedCases, OptionalRelatedCases):
    pass
