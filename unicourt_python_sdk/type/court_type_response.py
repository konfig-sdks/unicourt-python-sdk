...
class RequiredCourtTypeResponse(TypedDict):
    courtTypeArray: typing.List[CourtType]
...
class OptionalCourtTypeResponse(TypedDict, total=False):
    pass

class CourtTypeResponse(RequiredCourtTypeResponse, OptionalCourtTypeResponse):
    pass
