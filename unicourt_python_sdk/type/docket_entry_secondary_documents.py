...
class RequiredDocketEntrySecondaryDocuments(TypedDict):
    caseDocumentArray: typing.List[CaseDocument]
...
class OptionalDocketEntrySecondaryDocuments(TypedDict, total=False):
    pass

class DocketEntrySecondaryDocuments(RequiredDocketEntrySecondaryDocuments, OptionalDocketEntrySecondaryDocuments):
    pass
