...
class RequiredPartyRoleResponse(TypedDict):
    # Link to next page.
    ...
    partyRoleArray: typing.List[PartyRole]
...
class OptionalPartyRoleResponse(TypedDict, total=False):
    pass

class PartyRoleResponse(RequiredPartyRoleResponse, OptionalPartyRoleResponse):
    pass
