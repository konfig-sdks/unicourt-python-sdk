...
from unicourt_python_sdk.type.case_update_pacer_options_response_additional_page_array import CaseUpdatePacerOptionsResponseAdditionalPageArray

class RequiredCaseUpdatePacerOptionsResponse(TypedDict):
...
class OptionalCaseUpdatePacerOptionsResponse(TypedDict, total=False):
    pass

class CaseUpdatePacerOptionsResponse(RequiredCaseUpdatePacerOptionsResponse, OptionalCaseUpdatePacerOptionsResponse):
    pass
