...
class BaseApi(api_client.Api):
    ...
    def _get_associated_norm_judges_mapped_args(
        self,
    ...
    async def _aget_associated_norm_judges_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/normLawFirm/{normLawFirmId}/associatedNormJudges',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_associated_norm_judges_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAssociatedNormJudgesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_associated_norm_judges(
        self,
        norm_law_firm_id: str,
        page_number: int,
        q: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_associated_norm_judges_mapped_args(
            norm_law_firm_id=norm_law_firm_id,
            page_number=page_number,
            q=q,
        )
        return await self._aget_associated_norm_judges_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_associated_norm_judges(
        self,
        norm_law_firm_id: str,
        page_number: int,
        q: typing.Optional[str] = None,
        ...
        return self._get_associated_norm_judges_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAssociatedNormJudges(BaseApi):
    ...
    async def aget_associated_norm_judges(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_associated_norm_judges(
            norm_law_firm_id=norm_law_firm_id,
            page_number=page_number,
            q=q,
            **kwargs,
    ...
    def get_associated_norm_judges(
        ...
        raw_response = self.raw.get_associated_norm_judges(
            norm_law_firm_id=norm_law_firm_id,
            page_number=page_number,
            q=q,
        )
