...
from unicourt_python_sdk.model.party import Party as PartySchema
...
from unicourt_python_sdk.pydantic.party import Party as PartyPydantic
...
SchemaFor200ResponseBodyApplicationJson = PartySchema
...
class BaseApi(api_client.Api):
    ...
    def _get_party_details_mapped_args(
        self,
        party_id: str,
    ...
    async def _aget_party_details_oapg(
        self,
...
class GetPartyDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_party_details(
        self,
        party_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_party_details_mapped_args(
            party_id=party_id,
        )
        return await self._aget_party_details_oapg(
    ...
    def get_party_details(
        ...
        return self._get_party_details_oapg(
            path_params=args.path,
        )

class GetPartyDetails(BaseApi):
    ...
    async def aget_party_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_party_details(
            party_id=party_id,
            **kwargs,
        )
        if validate:
            return PartyPydantic(**raw_response.body)
        return api_client.construct_model_instance(PartyPydantic, raw_response.body)
    ...
    def get_party_details(
        ...
        raw_response = self.raw.get_party_details(
            party_id=party_id,
        )
        if validate:
            return PartyPydantic(**raw_response.body)
