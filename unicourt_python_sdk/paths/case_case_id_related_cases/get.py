...
from unicourt_python_sdk.model.related_cases import RelatedCases as RelatedCasesSchema
...
from unicourt_python_sdk.pydantic.related_cases import RelatedCases as RelatedCasesPydantic
...
SchemaFor200ResponseBodyApplicationJson = RelatedCasesSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_related_cases_mapped_args(
        self,
        case_id: str,
    ...
    async def _aget_related_cases_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/case/{caseId}/relatedCases',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetRelatedCasesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_related_cases(
        self,
        case_id: str,
        page_number: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_related_cases_mapped_args(
            case_id=case_id,
            page_number=page_number,
        )
        return await self._aget_related_cases_oapg(
    ...
    def get_related_cases(
        ...
        return self._get_related_cases_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetRelatedCases(BaseApi):
    ...
    async def aget_related_cases(
        ...
        validate: bool = False,
        **kwargs,
    ) -> RelatedCasesPydantic:
        raw_response = await self.raw.aget_related_cases(
            case_id=case_id,
            page_number=page_number,
            **kwargs,
        )
        if validate:
            return RelatedCasesPydantic(**raw_response.body)
        return api_client.construct_model_instance(RelatedCasesPydantic, raw_response.body)
    ...
    def get_related_cases(
        ...
        raw_response = self.raw.get_related_cases(
            case_id=case_id,
            page_number=page_number,
        )
        if validate:
