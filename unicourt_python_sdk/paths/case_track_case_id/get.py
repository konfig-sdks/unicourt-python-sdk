...
from unicourt_python_sdk.model.case_track import CaseTrack as CaseTrackSchema
...
from unicourt_python_sdk.type.case_track import CaseTrack

from ...api_client import Dictionary
from unicourt_python_sdk.pydantic.exception import Exception as ExceptionPydantic
from unicourt_python_sdk.pydantic.case_track import CaseTrack as CaseTrackPydantic
...
SchemaFor200ResponseBodyApplicationJson = CaseTrackSchema
...
SchemaFor451ResponseBodyApplicationJson = CaseTrackSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_case_track_mapped_args(
        self,
        case_id: str,
    ...
    async def _aget_case_track_oapg(
        self,
...
class GetCaseTrackRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_case_track(
        self,
        case_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_case_track_mapped_args(
            case_id=case_id,
        )
        return await self._aget_case_track_oapg(
    ...
    def get_case_track(
        ...
        return self._get_case_track_oapg(
            path_params=args.path,
        )

class GetCaseTrack(BaseApi):
    ...
    async def aget_case_track(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_case_track(
            case_id=case_id,
            **kwargs,
        )
        if validate:
            return CaseTrackPydantic(**raw_response.body)
        return api_client.construct_model_instance(CaseTrackPydantic, raw_response.body)
    ...
    def get_case_track(
        ...
        raw_response = self.raw.get_case_track(
            case_id=case_id,
        )
        if validate:
            return CaseTrackPydantic(**raw_response.body)
