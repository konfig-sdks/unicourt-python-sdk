...
class BaseApi(api_client.Api):
    ...
    def _search_appeal_courts_cases_0_mapped_args(
        self,
        pacer_user_id: str,
    ...
    async def _asearch_appeal_courts_cases_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/pacerCaseLocator/partySearch/appealCourts',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _search_appeal_courts_cases_0_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SearchAppealCourtsCases0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asearch_appeal_courts_cases_0(
        self,
        pacer_user_id: str,
        pacer_client_code: str,
        case_number: typing.Optional[typing.Optional[str]] = None,
        ...
        **kwargs,
        ...
        args = self._search_appeal_courts_cases_0_mapped_args(
        ...
        return await self._asearch_appeal_courts_cases_0_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def search_appeal_courts_cases_0(
        self,
        pacer_user_id: str,
        pacer_client_code: str,
        case_number: typing.Optional[typing.Optional[str]] = None,
        ...
        return self._search_appeal_courts_cases_0_oapg(
            query_params=args.query,
        )

class SearchAppealCourtsCases0(BaseApi):
    ...
    async def asearch_appeal_courts_cases_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asearch_appeal_courts_cases_0(
            pacer_user_id=pacer_user_id,
            pacer_client_code=pacer_client_code,
            case_number=case_number,
            pacer_case_id=pacer_case_id,
    ...
    def search_appeal_courts_cases_0(
        ...
        raw_response = self.raw.search_appeal_courts_cases_0(
            pacer_user_id=pacer_user_id,
            pacer_client_code=pacer_client_code,
            case_number=case_number,
            pacer_case_id=pacer_case_id,
