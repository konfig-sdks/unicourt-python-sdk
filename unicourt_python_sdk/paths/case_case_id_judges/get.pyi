...
from unicourt_python_sdk.model.judges import Judges as JudgesSchema
...
from unicourt_python_sdk.pydantic.judges import Judges as JudgesPydantic
...
SchemaFor200ResponseBodyApplicationJson = JudgesSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_judges_for_case_mapped_args(
        self,
        case_id: str,
    ...
    async def _aget_judges_for_case_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/case/{caseId}/judges',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetJudgesForCaseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_judges_for_case(
        self,
        case_id: str,
        is_visible: typing.Optional[bool] = None,
        page_number: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_judges_for_case_mapped_args(
            case_id=case_id,
            is_visible=is_visible,
            page_number=page_number,
        )
        return await self._aget_judges_for_case_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_judges_for_case(
        self,
        case_id: str,
        is_visible: typing.Optional[bool] = None,
        page_number: typing.Optional[int] = None,
        ...
        return self._get_judges_for_case_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetJudgesForCase(BaseApi):
    ...
    async def aget_judges_for_case(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_judges_for_case(
            case_id=case_id,
            is_visible=is_visible,
            page_number=page_number,
            **kwargs,
        ...
        if validate:
            return JudgesPydantic(**raw_response.body)
        return api_client.construct_model_instance(JudgesPydantic, raw_response.body)
    ...
    def get_judges_for_case(
        ...
        raw_response = self.raw.get_judges_for_case(
            case_id=case_id,
            is_visible=is_visible,
            page_number=page_number,
        )
