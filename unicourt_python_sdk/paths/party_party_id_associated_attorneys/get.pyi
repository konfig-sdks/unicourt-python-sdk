...
from unicourt_python_sdk.model.party_attorney_associations import PartyAttorneyAssociations as PartyAttorneyAssociationsSchema
...
from unicourt_python_sdk.pydantic.party_attorney_associations import PartyAttorneyAssociations as PartyAttorneyAssociationsPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'partyId': typing.Union[PartyIdSchema, str, ],
    }
)
...
request_path_party_id = api_client.PathParameter(
    name="partyId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=PartyIdSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = PartyAttorneyAssociationsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PartyAttorneyAssociations
...
class BaseApi(api_client.Api):
    ...
    def _get_associated_attorney_details_mapped_args(
        self,
        party_id: str,
    ...
    async def _aget_associated_attorney_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/party/{partyId}/associatedAttorneys',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_associated_attorney_details_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAssociatedAttorneyDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_associated_attorney_details(
        self,
        party_id: str,
        page_number: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_associated_attorney_details_mapped_args(
            party_id=party_id,
            page_number=page_number,
        )
        return await self._aget_associated_attorney_details_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_associated_attorney_details(
        self,
        party_id: str,
        page_number: typing.Optional[int] = None,
    ) -> typing.Union[
        ...
        return self._get_associated_attorney_details_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAssociatedAttorneyDetails(BaseApi):
    ...
    async def aget_associated_attorney_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PartyAttorneyAssociationsPydantic:
        raw_response = await self.raw.aget_associated_attorney_details(
            party_id=party_id,
            page_number=page_number,
            **kwargs,
        )
        if validate:
            return PartyAttorneyAssociationsPydantic(**raw_response.body)
        return api_client.construct_model_instance(PartyAttorneyAssociationsPydantic, raw_response.body)
    ...
    def get_associated_attorney_details(
        ...
        raw_response = self.raw.get_associated_attorney_details(
            party_id=party_id,
            page_number=page_number,
        )
        if validate:
