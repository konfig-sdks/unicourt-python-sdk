...
from unicourt_python_sdk.model.judge import Judge as JudgeSchema
...
from unicourt_python_sdk.type.judge import Judge

from ...api_client import Dictionary
from unicourt_python_sdk.pydantic.exception import Exception as ExceptionPydantic
from unicourt_python_sdk.pydantic.judge import Judge as JudgePydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'judgeId': typing.Union[JudgeIdSchema, str, ],
    }
)
...
request_path_judge_id = api_client.PathParameter(
    name="judgeId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=JudgeIdSchema,
    required=True,
)
_auth = [
    'bearerAuth',
]
SchemaFor200ResponseBodyApplicationJson = JudgeSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_judge_details_mapped_args(
        self,
        judge_id: str,
    ...
    async def _aget_judge_details_oapg(
        self,
...
class GetJudgeDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_judge_details(
        self,
        judge_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_judge_details_mapped_args(
            judge_id=judge_id,
        )
        return await self._aget_judge_details_oapg(
    ...
    def get_judge_details(
        ...
        return self._get_judge_details_oapg(
            path_params=args.path,
        )

class GetJudgeDetails(BaseApi):
    ...
    async def aget_judge_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_judge_details(
            judge_id=judge_id,
            **kwargs,
        )
        if validate:
            return JudgePydantic(**raw_response.body)
        return api_client.construct_model_instance(JudgePydantic, raw_response.body)
    ...
    def get_judge_details(
        ...
        raw_response = self.raw.get_judge_details(
            judge_id=judge_id,
        )
        if validate:
            return JudgePydantic(**raw_response.body)
