...
class FederalBankruptcyChapterArraySchema(
    schemas.ListSchema
):
    ...
    def __new__(
        ...
        arg: typing.Union[typing.Tuple[typing.Union[MetaOapg.items, None, str, ]], typing.List[typing.Union[MetaOapg.items, None, str, ]]],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'FederalBankruptcyChapterArraySchema':
        return super().__new__(
            cls,
            arg,
            _configuration=_configuration,
...
class CaseDischargedStartDateSchema(
    schemas.DateTimeBase,
    schemas.StrBase,
    schemas.NoneBase,
    schemas.Schema,
...
class CaseDischargedEndDateSchema(
    schemas.DateTimeBase,
    schemas.StrBase,
    schemas.NoneBase,
    schemas.Schema,
...
class CaseDismissedStartDateSchema(
    schemas.DateTimeBase,
    schemas.StrBase,
    schemas.NoneBase,
    schemas.Schema,
...
class CaseDismissedEndDateSchema(
    schemas.DateTimeBase,
    schemas.StrBase,
    schemas.NoneBase,
    schemas.Schema,
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'federalBankruptcyChapterArray': typing.Union[FederalBankruptcyChapterArraySchema, list, tuple, ],
        ...
        'caseDischargedStartDate': typing.Union[CaseDischargedStartDateSchema, None, str, datetime, ],
        'caseDischargedEndDate': typing.Union[CaseDischargedEndDateSchema, None, str, datetime, ],
        'caseDismissedStartDate': typing.Union[CaseDismissedStartDateSchema, None, str, datetime, ],
        'caseDismissedEndDate': typing.Union[CaseDismissedEndDateSchema, None, str, datetime, ],
...
request_query_federal_bankruptcy_chapter_array = api_client.QueryParameter(
    name="federalBankruptcyChapterArray",
    style=api_client.ParameterStyle.FORM,
    schema=FederalBankruptcyChapterArraySchema,
    explode=True,
)
...
request_query_case_discharged_start_date = api_client.QueryParameter(
    name="caseDischargedStartDate",
    style=api_client.ParameterStyle.FORM,
    schema=CaseDischargedStartDateSchema,
    explode=True,
)
request_query_case_discharged_end_date = api_client.QueryParameter(
    name="caseDischargedEndDate",
    style=api_client.ParameterStyle.FORM,
    schema=CaseDischargedEndDateSchema,
    explode=True,
)
request_query_case_dismissed_start_date = api_client.QueryParameter(
    name="caseDismissedStartDate",
    style=api_client.ParameterStyle.FORM,
    schema=CaseDismissedStartDateSchema,
    explode=True,
)
request_query_case_dismissed_end_date = api_client.QueryParameter(
    name="caseDismissedEndDate",
    style=api_client.ParameterStyle.FORM,
    schema=CaseDismissedEndDateSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _search_bankruptcy_cases_mapped_args(
        self,
        pacer_user_id: str,
        ...
        federal_bankruptcy_chapter_array: typing.Optional[typing.List[typing.Optional[str]]] = None,
        ...
        case_discharged_start_date: typing.Optional[typing.Optional[datetime]] = None,
        case_discharged_end_date: typing.Optional[typing.Optional[datetime]] = None,
        case_dismissed_start_date: typing.Optional[typing.Optional[datetime]] = None,
        case_dismissed_end_date: typing.Optional[typing.Optional[datetime]] = None,
        ...
        if federal_bankruptcy_chapter_array is not None:
            _query_params["federalBankruptcyChapterArray"] = federal_bankruptcy_chapter_array
        ...
        if case_discharged_start_date is not None:
            _query_params["caseDischargedStartDate"] = case_discharged_start_date
        if case_discharged_end_date is not None:
            _query_params["caseDischargedEndDate"] = case_discharged_end_date
        if case_dismissed_start_date is not None:
            _query_params["caseDismissedStartDate"] = case_dismissed_start_date
        if case_dismissed_end_date is not None:
            _query_params["caseDismissedEndDate"] = case_dismissed_end_date
    ...
    async def _asearch_bankruptcy_cases_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_federal_bankruptcy_chapter_array,
            ...
            request_query_case_discharged_start_date,
            request_query_case_discharged_end_date,
            request_query_case_dismissed_start_date,
            request_query_case_dismissed_end_date,
        ...
        request_before_hook(
            ...
            path_template='/pacerCaseLocator/caseSearch/bankruptcyCourts',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _search_bankruptcy_cases_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SearchBankruptcyCasesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asearch_bankruptcy_cases(
        self,
        pacer_user_id: str,
        pacer_client_code: str,
        case_number: typing.Optional[typing.Optional[str]] = None,
        ...
        **kwargs,
        ...
        args = self._search_bankruptcy_cases_mapped_args(
        ...
        return await self._asearch_bankruptcy_cases_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def search_bankruptcy_cases(
        self,
        pacer_user_id: str,
        pacer_client_code: str,
        case_number: typing.Optional[typing.Optional[str]] = None,
        ...
        return self._search_bankruptcy_cases_oapg(
            query_params=args.query,
        )

class SearchBankruptcyCases(BaseApi):
    ...
    async def asearch_bankruptcy_cases(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asearch_bankruptcy_cases(
            pacer_user_id=pacer_user_id,
            pacer_client_code=pacer_client_code,
            case_number=case_number,
            pacer_case_id=pacer_case_id,
    ...
    def search_bankruptcy_cases(
        ...
        raw_response = self.raw.search_bankruptcy_cases(
            pacer_user_id=pacer_user_id,
            pacer_client_code=pacer_client_code,
            case_number=case_number,
            pacer_case_id=pacer_case_id,
