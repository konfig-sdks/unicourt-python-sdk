...
from unicourt_python_sdk.model.hearings import Hearings as HearingsSchema
...
from unicourt_python_sdk.pydantic.hearings import Hearings as HearingsPydantic
...
SchemaFor200ResponseBodyApplicationJson = HearingsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_hearings_for_case_mapped_args(
        self,
        case_id: str,
    ...
    async def _aget_hearings_for_case_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/case/{caseId}/hearings',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_hearings_for_case_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetHearingsForCaseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_hearings_for_case(
        self,
        case_id: str,
        sort_by: typing.Optional[str] = None,
        page_number: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_hearings_for_case_mapped_args(
            case_id=case_id,
            sort_by=sort_by,
            page_number=page_number,
        )
        return await self._aget_hearings_for_case_oapg(
    ...
    def get_hearings_for_case(
        ...
        return self._get_hearings_for_case_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetHearingsForCase(BaseApi):
    ...
    async def aget_hearings_for_case(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_hearings_for_case(
            case_id=case_id,
            sort_by=sort_by,
            page_number=page_number,
            **kwargs,
        ...
        if validate:
            return HearingsPydantic(**raw_response.body)
        return api_client.construct_model_instance(HearingsPydantic, raw_response.body)
    ...
    def get_hearings_for_case(
        ...
        raw_response = self.raw.get_hearings_for_case(
            case_id=case_id,
            sort_by=sort_by,
            page_number=page_number,
        )
