...
from unicourt_python_sdk.model.docket_entries import DocketEntries as DocketEntriesSchema
...
from unicourt_python_sdk.pydantic.docket_entries import DocketEntries as DocketEntriesPydantic
...
SchemaFor200ResponseBodyApplicationJson = DocketEntriesSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_docket_entries_mapped_args(
        self,
        case_id: str,
        docket_number: typing.Optional[int] = None,
    ...
    async def _aget_docket_entries_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/case/{caseId}/docketEntries',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDocketEntriesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_docket_entries(
        self,
        case_id: str,
        docket_number: typing.Optional[int] = None,
        sort_by: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_docket_entries_mapped_args(
            case_id=case_id,
            docket_number=docket_number,
            sort_by=sort_by,
            page_number=page_number,
        )
        return await self._aget_docket_entries_oapg(
    ...
    def get_docket_entries(
        ...
        return self._get_docket_entries_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetDocketEntries(BaseApi):
    ...
    async def aget_docket_entries(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DocketEntriesPydantic:
        raw_response = await self.raw.aget_docket_entries(
            case_id=case_id,
            docket_number=docket_number,
            sort_by=sort_by,
            page_number=page_number,
        ...
        if validate:
            return DocketEntriesPydantic(**raw_response.body)
        return api_client.construct_model_instance(DocketEntriesPydantic, raw_response.body)
    ...
    def get_docket_entries(
        ...
        raw_response = self.raw.get_docket_entries(
            case_id=case_id,
            docket_number=docket_number,
            sort_by=sort_by,
            page_number=page_number,
