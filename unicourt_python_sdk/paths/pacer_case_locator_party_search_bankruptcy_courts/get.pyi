...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'ssnOrEin': typing.Union[SsnOrEinSchema, None, str, ],
        'fourDigitSsn': typing.Union[FourDigitSsnSchema, None, str, ],
...
request_query_ssn_or_ein = api_client.QueryParameter(
    name="ssnOrEin",
    style=api_client.ParameterStyle.FORM,
    schema=SsnOrEinSchema,
    explode=True,
)
request_query_four_digit_ssn = api_client.QueryParameter(
    name="fourDigitSsn",
    style=api_client.ParameterStyle.FORM,
    schema=FourDigitSsnSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _search_bankruptcy_courts_mapped_args(
        self,
        pacer_user_id: str,
        ...
        ssn_or_ein: typing.Optional[typing.Optional[str]] = None,
        four_digit_ssn: typing.Optional[typing.Optional[str]] = None,
        ...
        if ssn_or_ein is not None:
            _query_params["ssnOrEin"] = ssn_or_ein
        if four_digit_ssn is not None:
            _query_params["fourDigitSsn"] = four_digit_ssn
    ...
    async def _asearch_bankruptcy_courts_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_ssn_or_ein,
            request_query_four_digit_ssn,
        ...
        request_before_hook(
            ...
            path_template='/pacerCaseLocator/partySearch/bankruptcyCourts',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _search_bankruptcy_courts_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SearchBankruptcyCourtsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asearch_bankruptcy_courts(
        self,
        pacer_user_id: str,
        pacer_client_code: str,
        case_number: typing.Optional[typing.Optional[str]] = None,
        ...
        **kwargs,
        ...
        args = self._search_bankruptcy_courts_mapped_args(
        ...
        return await self._asearch_bankruptcy_courts_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def search_bankruptcy_courts(
        self,
        pacer_user_id: str,
        pacer_client_code: str,
        case_number: typing.Optional[typing.Optional[str]] = None,
        ...
        return self._search_bankruptcy_courts_oapg(
            query_params=args.query,
        )

class SearchBankruptcyCourts(BaseApi):
    ...
    async def asearch_bankruptcy_courts(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asearch_bankruptcy_courts(
            pacer_user_id=pacer_user_id,
            pacer_client_code=pacer_client_code,
            case_number=case_number,
            pacer_case_id=pacer_case_id,
    ...
    def search_bankruptcy_courts(
        ...
        raw_response = self.raw.search_bankruptcy_courts(
            pacer_user_id=pacer_user_id,
            pacer_client_code=pacer_client_code,
            case_number=case_number,
            pacer_case_id=pacer_case_id,
