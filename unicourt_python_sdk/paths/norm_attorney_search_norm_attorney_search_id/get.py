...
class NormAttorneySearchIdSchema(
    schemas.StrSchema
):
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    ...
    {
        'normAttorneySearchId': typing.Union[NormAttorneySearchIdSchema, str, ],
    }
)
...
request_path_norm_attorney_search_id = api_client.PathParameter(
    name="normAttorneySearchId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=NormAttorneySearchIdSchema,
    required=True,
)
_auth = [
    'bearerAuth',
...
class BaseApi(api_client.Api):
    ...
    def _get_norm_attorney_search_results_mapped_args(
        self,
        norm_attorney_search_id: str,
    ...
    async def _aget_norm_attorney_search_results_oapg(
        self,
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_norm_attorney_search_id,
        ):
        ...
        request_before_hook(
            ...
            path_template='/normAttorneySearch/{normAttorneySearchId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_norm_attorney_search_results_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetNormAttorneySearchResultsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_norm_attorney_search_results(
        self,
        norm_attorney_search_id: str,
        page_number: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_norm_attorney_search_results_mapped_args(
            norm_attorney_search_id=norm_attorney_search_id,
            page_number=page_number,
        )
        return await self._aget_norm_attorney_search_results_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_norm_attorney_search_results(
        self,
        norm_attorney_search_id: str,
        page_number: typing.Optional[int] = None,
    ) -> typing.Union[
        ...
        return self._get_norm_attorney_search_results_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetNormAttorneySearchResults(BaseApi):
    ...
    async def aget_norm_attorney_search_results(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_norm_attorney_search_results(
            norm_attorney_search_id=norm_attorney_search_id,
            page_number=page_number,
            **kwargs,
        )
    ...
    def get_norm_attorney_search_results(
        ...
        raw_response = self.raw.get_norm_attorney_search_results(
            norm_attorney_search_id=norm_attorney_search_id,
            page_number=page_number,
        )
        if validate:
