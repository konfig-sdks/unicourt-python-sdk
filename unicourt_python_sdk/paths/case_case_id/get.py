...
from unicourt_python_sdk.model.case import Case as CaseSchema

from unicourt_python_sdk.type.exception import Exception
from unicourt_python_sdk.type.case import Case

from ...api_client import Dictionary
from unicourt_python_sdk.pydantic.case import Case as CasePydantic
...
SchemaFor200ResponseBodyApplicationJson = CaseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_case_info_mapped_args(
        self,
        case_id: str,
    ...
    async def _aget_case_info_oapg(
        self,
...
class GetCaseInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_case_info(
        self,
        case_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_case_info_mapped_args(
            case_id=case_id,
        )
        return await self._aget_case_info_oapg(
    ...
    def get_case_info(
        ...
        return self._get_case_info_oapg(
            path_params=args.path,
        )

class GetCaseInfo(BaseApi):
    ...
    async def aget_case_info(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_case_info(
            case_id=case_id,
            **kwargs,
        )
        if validate:
            return CasePydantic(**raw_response.body)
        return api_client.construct_model_instance(CasePydantic, raw_response.body)
    ...
    def get_case_info(
        ...
        raw_response = self.raw.get_case_info(
            case_id=case_id,
        )
        if validate:
            return CasePydantic(**raw_response.body)
